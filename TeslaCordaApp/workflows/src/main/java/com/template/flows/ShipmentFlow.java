...
public class ShipmentFlow extends FlowLogic<SignedTransaction>{
    ...
    public SignedTransaction call() throws FlowException {
        ...
        //create transaction and add components
        TransactionBuilder txBuilder=new TransactionBuilder(notary)
                .addOutputState(outputState, CarContract.CAR_CONTRACT_ID)
        ...
        //create session with cunterparty

        FlowSession otherPartySession =initiateFlow(owner);

        //verify transaction to notary and commit the transaction
